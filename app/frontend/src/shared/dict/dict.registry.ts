...
export const workflowTypeOptions: DictOption<WorkflowType>[] = [
  ...
  { label: '素材剪辑成片', value: 'material_edit', disabled: true },
  { label: '纯图文成片', value: 'image_slideshow', disabled: true },
]
...
export const taskKindOptions: DictOption<TaskKind>[] = [{ label: '图生视频作品', value: 'image_to_video' }]
